...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'pathos', // Pathos Digital Garden 风格；Notion 配置中心可覆盖
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Patrick', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '技术、阅读与日常记录。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://pathos.site', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://cdn.jsdelivr.net/gh/perinchiang/notion-image-bed@main/images/flower2.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  // 自定义菜单
  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 极简导航；避免显示模板菜单
